        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="name" id="name" class="border p-3 w-full rounded @error('name') border-red-500 @enderror" placeholder="Tu Nombre" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="username" id="username" class="border p-3 w-full rounded @error('username') border-red-500 @enderror" placeholder="Tu Nombre de Usuario" value="{{ old('username') }}">
                    @error('username')
                        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                    @enderror
                </div>
